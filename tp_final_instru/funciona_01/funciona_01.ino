...
void setup() {
  ...
  // configuración de los puertos de salida de los LEDs
...
void loop() {
  ...
  if(db_spl > 95) {
    digitalWrite(GREEN_LED, LOW);
    digitalWrite(YELLOW_LED, LOW);
    // en caso de que el nivel de ruido sea excesivo hago parpadear el led rojo
    digitalWrite(RED_LED, HIGH);
    delay(200);
    digitalWrite(RED_LED, LOW);
    delay(200);
  ...
  delay(200); // ajustar según necesidad
}